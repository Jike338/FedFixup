    ...
    for r in range(args.start_round, args.rounds, 1):
        ...
        for client_id in client_ids_round:
            ...
            if args.steps > 0:
                ...
                adjust_learning_rate_with_epoch(optimizer, r, args)
...
def adjust_learning_rate_with_epoch(optimizer, epoch, args):
    """Sets the learning rate to the initial LR decayed by 10 every 30 epochs"""
    if epoch > 0.9*args.rounds:
        lr = args.lr * 0.001
    elif epoch > 0.6*args.rounds:
        lr = args.lr * 0.01
    elif epoch > 0.3*args.rounds:
        lr = args.lr * 0.1
    else:
        lr = args.lr   
