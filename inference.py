...
def main_worker(gpu, ngpus_per_node, args):
    ...
    args.logdir = "/research/nfs_chao_209/jike/DelayBN/save_centralized_models"
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        if epoch%10 == 0 and args.save_model:
            ...
            }, is_best, args.logdir, filename='%s_checkpoint_ep%d.pth.tar'%(args.norm_layer, epoch) if epoch%10==0 else 'checkpoint.pth.tar')
        print(accs)
        raise
